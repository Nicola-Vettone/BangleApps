...
// abbassata: così valori tipo "0 c18" contano come "worn"
...
function drawSleepIcon() {
  ...
  // disegna icona in base allo stato
...
// ===========================
// Original code (unchanged) + icon at end
// ===========================
function drawClock() {
...
function startSensorCycle() {
  // HRM sempre attivo (come originale)
